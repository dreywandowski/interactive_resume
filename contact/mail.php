...
try {
    ...
    $mail->send();
    echo 'Thanks, your message has been sent successfully. Return '."<a href='index.php'>Home</a>";
...
else echo "please "."<a href='index.php'>Go Back</a>"." and put in a valid details";
